...
In this code, S is a zero sized type or ZST. Zero sized types (https://doc.rust-lang.org/nomicon/exotic-sizes.html#zero-sized-types-zsts) are compile-time concepts that disappear during compilation and have a runtime representation of zero bytes.
