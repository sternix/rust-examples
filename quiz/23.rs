...
It is important for macro authors to be aware of this. Macro-generated code typically should not use method call syntax to invoke trait methods on types defined by the user. Those calls could get unintentionally hijacked by inherent methods having the same name as the trait method.
...
See this Stack Overflow ( https://stackoverflow.com/a/28552082/6086311 )  answer for a more detailed explanation of auto-ref during method resolution.
